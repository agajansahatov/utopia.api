...
public class User {
    ...
    public User(Long id, String contact, String password, short role_id, String firstname, String lastname, BigDecimal balance, String country, String province, String city, String address, Timestamp authTime) {
        this.id = id;
